...
const LOCOMOTION_GLB_ROOT = "/models/animations/locomotion";
const COMBAT_GLB_ROOT     = "/models/animations/combat";

const NAME_GLB: Array<[string, string]> = [
  // ── Multi-word phrases first (most specific) ──────────────────────────────
  ["mountain climber",  `${LOCOMOTION_GLB_ROOT}/Running_1.glb`],
  ["box jump",          `${FITNESS_GLB_ROOT}/Box_Jump_1.glb`],
  ["squat jump",        `${FITNESS_GLB_ROOT}/Box_Jump_1.glb`],
  ["jump squat",        `${FITNESS_GLB_ROOT}/Box_Jump_1.glb`],
  ["jump push",         `${FITNESS_GLB_ROOT}/Jump_Push_Up_1.glb`],
  ["flutter kick",      `${FITNESS_GLB_ROOT}/Bicycle_Crunch_1.glb`],
  ["march in place",    `${LOCOMOTION_GLB_ROOT}/Quick_Steps_1.glb`],
  ["knee raise march",  `${LOCOMOTION_GLB_ROOT}/Running_1.glb`],
  ["high knees",        `${LOCOMOTION_GLB_ROOT}/Running_1.glb`],
  ["shadow box",        `${COMBAT_GLB_ROOT}/Speedbag_1.glb`],
  ...
  ["shoulder press",    `${FITNESS_GLB_ROOT}/Overhead_Squat_1.glb`],
  ["split squat",       `${FITNESS_GLB_ROOT}/Pistol_1.glb`],
  ["walking lunge",     `${FITNESS_GLB_ROOT}/Pistol_1.glb`],
  ["romanian deadlift", `${FITNESS_GLB_ROOT}/Kettlebell_Swing_3.glb`],
  ["push-up",           `${FITNESS_GLB_ROOT}/Push_Up.glb`],
  ["push up",           `${FITNESS_GLB_ROOT}/Push_Up.glb`],
  ["sit-up",            `${FITNESS_GLB_ROOT}/Situps_1.glb`],
  ["sit up",            `${FITNESS_GLB_ROOT}/Situps_1.glb`],
  ["glute bridge",      `${FITNESS_GLB_ROOT}/Situp_To_Idle_1.glb`],
  ["dead bug",          `${FITNESS_GLB_ROOT}/Situp_To_Idle_1.glb`],
  ["bicycle crunch",    `${FITNESS_GLB_ROOT}/Bicycle_Crunch_1.glb`],
  ...
  // ── Single keywords ───────────────────────────────────────────────────────
  ["deadlift",          `${FITNESS_GLB_ROOT}/Kettlebell_Swing_3.glb`],
  ["romanian",          `${FITNESS_GLB_ROOT}/Kettlebell_Swing_3.glb`],
  ["rdl",               `${FITNESS_GLB_ROOT}/Kettlebell_Swing_3.glb`],
  ["bulgarian",         `${FITNESS_GLB_ROOT}/Pistol_1.glb`],
  ["pistol",            `${FITNESS_GLB_ROOT}/Pistol_1.glb`],
  ...
  ["bicycle",           `${FITNESS_GLB_ROOT}/Bicycle_Crunch_1.glb`],
  ["crunch",            `${FITNESS_GLB_ROOT}/Circle_Crunch_1.glb`],
  ["situp",             `${FITNESS_GLB_ROOT}/Situps_1.glb`],
  ...
  ["press",             `${FITNESS_GLB_ROOT}/Overhead_Squat_1.glb`],
  ["jack",              `${FITNESS_GLB_ROOT}/Jumping_Jacks_1.glb`],
  ["jump",              `${FITNESS_GLB_ROOT}/Box_Jump_1.glb`],
  ["march",             `${FITNESS_GLB_ROOT}/Front_Raises_1.glb`],
  ["lunge",             `${FITNESS_GLB_ROOT}/Pistol_1.glb`],
...
const CATEGORY_GLB: Record<string, string> = {
  ...
  core:         `${FITNESS_GLB_ROOT}/Situps_1.glb`,
